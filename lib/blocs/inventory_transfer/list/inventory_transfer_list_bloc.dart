...
class InventoryTransferListBloc extends BlocEventStateBase<
    InventoryTransferListEvent, InventoryTransferListState> {
  ...
  @override
  Stream<InventoryTransferListState> eventHandler(
      InventoryTransferListEvent event,
