...
TransferRequestDetailResponse _$TransferRequestDetailResponseFromJson(
...
Map<String, dynamic> _$TransferRequestDetailResponseToJson(
        TransferRequestDetailResponse instance) =>
    <String, dynamic>{
