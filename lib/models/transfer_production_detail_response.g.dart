...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
    prodOrderId: json['ProdOrderId'] as int,
    prodOrderNo: json['ProdOrderNo'] as String,
    prodDate: json['ProdDate'] == null
        ? null
        : DateTime.parse(json['ProdDate'] as String),
...
Map<String, dynamic> _$DataToJson(Data instance) => <String, dynamic>{
      ...
      'ProdOrderNo': instance.prodOrderNo,
      'ProdDate': instance.prodDate?.toIso8601String(),
