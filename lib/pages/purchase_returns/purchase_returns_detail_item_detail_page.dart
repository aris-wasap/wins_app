...
class PurchaseReturnsDetailItemDetailPage extends StatefulWidget {
  PurchaseReturnsDetailItemDetailPage(this._data);
  final Item _data;
  @override
  _PurchaseReturnsDetailItemDetailPageState createState() =>
      _PurchaseReturnsDetailItemDetailPageState(_data);
}

class _PurchaseReturnsDetailItemDetailPageState
    extends State<PurchaseReturnsDetailItemDetailPage> {
  _PurchaseReturnsDetailItemDetailPageState(this._data);

  final Item _data;
  PurchaseReturnsDetailItemDetailBloc bloc;
  ...
  void _done() {
    ...
    bloc.emitEvent(PurchaseReturnsDetailItemDetailEventQty(
  ...
  PurchaseReturnsDetailItemDetailState _getState() {
    return bloc.lastState ?? bloc.initialState;
  }

  @override
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<PurchaseReturnsDetailItemDetailState>(
        bloc: bloc,
        builder:
            (BuildContext context, PurchaseReturnsDetailItemDetailState state) {
          return SafeArea(
              child: Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
  ...
  Widget _buildForm() {
    ...
    _qtyPoController.text = data.grpoQty.toString();
    if (_data.qty != 0) {
