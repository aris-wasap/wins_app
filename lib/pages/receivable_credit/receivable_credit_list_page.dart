...
import 'package:wins_app/blocs/receivable_credit/list/receivable_credit_list_bloc.dart';
...
import 'package:wins_app/pages/receivable_credit/receivable_credit_detail_page.dart';
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: <Widget>[
                    Text(
                        "Return No. : ${data[index].sapReceivableCreditNo} - ${DateFormat('dd/MM/yyyy').format(data[index].transDate)}"), //"No. ${data[index].transNo} (${data[index].id.toString()}) ")
