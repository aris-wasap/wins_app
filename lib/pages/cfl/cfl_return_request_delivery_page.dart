...
class _CflReturnRequestDeliveryPageState
  ...
  _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 2000), () {
      bloc.emitEvent(CflReturnRequestDeliveryEvent(
        event: CflReturnRequestDeliveryEventType.firstPage,
  ...
  void _onScroll() {
    if (_scrollController.offset ==
      ...
      bloc.emitEvent(CflReturnRequestDeliveryEvent(
        event: CflReturnRequestDeliveryEventType.nextPage,
        searchQuery: _searchQueryController.text,
      ));
    }
  }
  ...
  PreferredSizeWidget _appBar(CflReturnRequestDeliveryState state) {
        ...
        actions: <Widget>[
          IconButton(
              ...
              onPressed: () {
                ...
                bloc.emitEvent(CflReturnRequestDeliveryEvent(
                  event: CflReturnRequestDeliveryEventType.deactivedSearch,
                  searchQuery: _searchQueryController.text,
                ));
              }),
        ],
      ...
      return AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              bloc.emitEvent(CflReturnRequestDeliveryEvent(
                event: CflReturnRequestDeliveryEventType.activedSearch,
              ));
            },
          ),
        ],
  ...
  Future<void> _handleRefresh() async {
    bloc.emitEvent(CflReturnRequestDeliveryEvent(
      event: CflReturnRequestDeliveryEventType.refresh,
      searchQuery: _searchQueryController.text,
    ));
  }
  ...
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<CflReturnRequestDeliveryState>(
        bloc: bloc,
        builder: (BuildContext context, CflReturnRequestDeliveryState state) {
          return SafeArea(
            child: Scaffold(
              key: _scaffoldKey,
  ...
  Widget buildList(CflReturnRequestDeliveryState state) {
