...
class _CflPurchaseSupplierPageState extends State<CflPurchaseSupplierPage> {
  CflPurchaseSupplierBloc bloc = CflPurchaseSupplierBloc();
  ...
  _onSearchChanged() {
    ...
    _debounce = Timer(const Duration(milliseconds: 2000), () {
      bloc.emitEvent(CflPurchaseSupplierEvent(
        event: CflPurchaseSupplierEventType.firstPage,
  ...
  void _onScroll() {
    if (_scrollController.offset ==
      ...
      bloc.emitEvent(CflPurchaseSupplierEvent(
        event: CflPurchaseSupplierEventType.nextPage,
        searchQuery: _searchQueryController.text,
      ));
    }
  }
  ...
  PreferredSizeWidget _appBar(CflPurchaseSupplierState state) {
        ...
        actions: <Widget>[
          IconButton(
              ...
              onPressed: () {
                ...
                bloc.emitEvent(CflPurchaseSupplierEvent(
                  event: CflPurchaseSupplierEventType.deactivedSearch,
                  searchQuery: _searchQueryController.text,
                ));
              }),
        ],
      ...
      return AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              bloc.emitEvent(CflPurchaseSupplierEvent(
                event: CflPurchaseSupplierEventType.activedSearch,
              ));
            },
          ),
        ],
  ...
  Future<void> _handleRefresh() async {
    bloc.emitEvent(CflPurchaseSupplierEvent(
      event: CflPurchaseSupplierEventType.refresh,
      searchQuery: _searchQueryController.text,
    ));
  }
  ...
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<CflPurchaseSupplierState>(
        bloc: bloc,
        builder: (BuildContext context, CflPurchaseSupplierState state) {
          return SafeArea(
            child: Scaffold(
              key: _scaffoldKey,
  ...
  Widget buildList(CflPurchaseSupplierState state) {
