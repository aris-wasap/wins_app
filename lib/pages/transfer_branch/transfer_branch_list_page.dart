...
import 'package:admart_app/blocs/transfer_branch/list/transfer_branch_list_bloc.dart';
...
import 'package:admart_app/pages/transfer_branch/transfer_branch_detail_page.dart';
            ...
            child: Padding(
              ...
              child: ListTile(
                title: data[index].status == 'Draft'
                    ...
                    : Text(
                        "No. ${data[index].sapTransferBranchNo} - ${DateFormat('dd/MM/yyyy').format(data[index].transDate)}"), //"No. ${data[index].transNo} (${data[index].id.toString()}) ")
                subtitle: Column(
