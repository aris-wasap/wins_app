...
import 'package:admart_app/blocs/goods_receipt/detail_item_detail/goods_receipt_detail_item_detail_bloc.dart';
...
class _GoodsReceiptDetailItemDetailPageState
  ...
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<GoodsReceiptDetailItemDetailState>(
        bloc: bloc,
        builder: (BuildContext context, GoodsReceiptDetailItemDetailState state) {
          return SafeArea(
              child: Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
