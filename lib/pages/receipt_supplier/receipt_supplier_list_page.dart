...
import 'package:wins_app/blocs/receipt_supplier/list/receipt_supplier_list_bloc.dart';
...
import 'package:wins_app/pages/receipt_supplier/receipt_supplier_detail_page.dart';
import 'package:intl/intl.dart';
import 'package:wins_app/widgets/set_colors.dart';

class ReceiptSupplierListPage extends StatefulWidget {
  @override
  _ReceiptSupplierListPageState createState() =>
      _ReceiptSupplierListPageState();
}
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: <Widget>[
                    Text(
                        "Receipt No. : ${data[index].sapReceiptSupplierNo} - ${DateFormat('dd/MM/yyyy').format(data[index].transDate)}"), //"No. ${data[index].transNo} (${data[index].id.toString()}) ")
