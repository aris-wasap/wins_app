...
import 'package:wins_app/blocs/request_issue/detail_item_detail/request_issue_detail_item_detail_bloc.dart';
import 'package:wins_app/blocs/request_issue/detail_item_detail/request_issue_detail_item_detail_event.dart';
import 'package:wins_app/blocs/request_issue/detail_item_detail/request_issue_detail_item_detail_state.dart';
...
class RequestIssueDetailItemDetailPage extends StatefulWidget {
  RequestIssueDetailItemDetailPage(this._data);
  final Item _data;
  @override
  _RequestIssueDetailItemDetailPageState createState() =>
      _RequestIssueDetailItemDetailPageState(_data);
}

class _RequestIssueDetailItemDetailPageState
    extends State<RequestIssueDetailItemDetailPage> {
  _RequestIssueDetailItemDetailPageState(this._data);

  final Item _data;
  RequestIssueDetailItemDetailBloc bloc;
  ...
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<RequestIssueDetailItemDetailState>(
        bloc: bloc,
        builder:
            (BuildContext context, RequestIssueDetailItemDetailState state) {
          return SafeArea(
              child: Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
