...
import 'package:ncf_app/pages/transfer_request/transfer_request_detail_item_detail_page.dart';
import 'package:flutter/material.dart';
import 'package:ncf_app/bloc_widgets/bloc_state_builder.dart';
import 'package:ncf_app/blocs/transfer_request/detail/transfer_request_detail_bloc.dart';
        ...
        if (_getState().data.id == 0) {
          return Dismissible(
            ...
            onDismissed: (direction) {
              bloc.emitEvent(TransferRequestDetailEventItemRemove(itemIndex: index));
            },
