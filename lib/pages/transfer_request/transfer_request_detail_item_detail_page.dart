...
import 'package:ncf_app/blocs/transfer_request/detail_item_detail/transfer_request_detail_item_detail_bloc.dart';
import 'package:ncf_app/blocs/transfer_request/detail_item_detail/transfer_request_detail_item_detail_event.dart';
import 'package:ncf_app/blocs/transfer_request/detail_item_detail/transfer_request_detail_item_detail_state.dart';
...
class TransferRequestDetailItemDetailPage extends StatefulWidget {
  TransferRequestDetailItemDetailPage(this._data);
  final Item _data;
  @override
  _TransferRequestDetailItemDetailPageState createState() =>
      _TransferRequestDetailItemDetailPageState(_data);
}

class _TransferRequestDetailItemDetailPageState
    extends State<TransferRequestDetailItemDetailPage> {
  _TransferRequestDetailItemDetailPageState(this._data);

  final Item _data;
  TransferRequestDetailItemDetailBloc bloc;
  ...
  void initState() {
    ...
    bloc = TransferRequestDetailItemDetailBloc(this._data);
  }
  ...
  void _done() {
    ...
    bloc.emitEvent(TransferRequestDetailItemDetailEventQty(
      qty: double.parse(_qtyController.text.replaceAll(new RegExp(','), '')),
    ));
    Navigator.pop(context, _getState().data);
  }

  TransferRequestDetailItemDetailState _getState() {
    return bloc.lastState ?? bloc.initialState;
  }

  @override
  Widget build(BuildContext context) {
    return BlocEventStateBuilder<TransferRequestDetailItemDetailState>(
        bloc: bloc,
        builder:
            (BuildContext context, TransferRequestDetailItemDetailState state) {
          return SafeArea(
              child: Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
