...
import 'package:wins_app/blocs/delivery_order/list/delivery_order_list_bloc.dart';
import 'package:wins_app/blocs/delivery_order/list/delivery_order_list_event.dart';
import 'package:wins_app/blocs/delivery_order/list/delivery_order_list_state.dart';
import 'package:wins_app/pages/delivery_order/delivery_order_detail_page.dart';
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: <Widget>[
                    Text(
                        "DO No. : ${data[index].sapDeliveryNo} - ${DateFormat('dd/MM/yyyy').format(data[index].transDate)}"),
